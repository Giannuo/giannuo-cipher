 ...
 * @since 1.0
 */
public final class DESedeEncrypt extends CipherEncrypt implements IvSupport {
    /**
     * 秘钥规则
     *
     * @since 1.0
     ...
     * @since 1.0
     */
    public DESedeEncrypt(@NotNull String base64Key, @NotNull String charsetName) {
     ...
     * @since 1.0
     */
    public DESedeEncrypt(@NotNull String base64Key, @NotNull Charset charset) {
        ...
        this.ivParameterSpec = new IvParameterSpec(randomByteArray(CipherConsts.ALGORITHM_DESede_DEF_IV_BYTE_SIZE));
    }
