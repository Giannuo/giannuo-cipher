...
import com.giannuo.cipher.AESCipherUtil;
import com.giannuo.cipher.AESDecrypt;
import com.giannuo.cipher.AESEncrypt;
...
public class TestAESCipherUtil {
    AESCipherUtil util = AESCipherUtil.SINGLETON;
    ...
    public void testGenerateBase64KeyWithKeySize() {
        int[] keySizeArray = new int[]{128, 192, 256};
    ...
    public void testAESCrypt() {
        ...
        String key = util.generateBase64Key(256);

        AESEncrypt cipherEncrypt = new AESEncrypt(key, charsetName);
        ...
        String unsecretData = util.decrypt(secretData, () -> new AESDecrypt(cipherEncrypt.getBase64Key(), cipherEncrypt.getBase64Iv(), charsetName));
    ...
    public void testAESCryptFile() {
        ...
        File decryptedFile = util.decryptFile(sourceFilePath$todoDecrypt, destFilePath$doneDecrypt, () -> new AESDecrypt(cipherEncrypt.getBase64Key(), cipherEncrypt.getBase64Iv(), charsetName));
