...
import com.giannuo.cipher.DESedeCipherUtil;
import com.giannuo.cipher.DESedeDecrypt;
import com.giannuo.cipher.DESedeEncrypt;
...
public class TestDESedeCipherUtil {
    DESedeCipherUtil util = DESedeCipherUtil.SINGLETON;
    ...
    public void testGenerateBase64KeyWithKeySize() {
        int[] keySizeArray = new int[]{112, 168};
    ...
    public void testDESedeCrypt() {
        ...
        String key = util.generateBase64Key(168);

        DESedeEncrypt cipherEncrypt = new DESedeEncrypt(key, charsetName);
        ...
        String unsecretData = util.decrypt(secretData, () -> new DESedeDecrypt(cipherEncrypt.getBase64Key(), cipherEncrypt.getBase64Iv(), charsetName));
    ...
    @Test
    public void testDESedeCryptFile() {
        ...
        File decryptedFile = util.decryptFile(sourceFilePath$todoDecrypt, destFilePath$doneDecrypt, () -> new DESedeDecrypt(cipherEncrypt.getBase64Key(), cipherEncrypt.getBase64Iv(), charsetName));
